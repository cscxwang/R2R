...
parser.add_argument("--init_ckpt_dir", type=str, default="train_ckpt_3D", help="Directory of the pretrained checkpoints used to initialize finetuning")
parser.add_argument("--init_prompt_dir", type=str, default="save_prompts_3D", help="Directory of the pretrained prompts used to initialize finetuning")
...
mode_defaults = {
    ...
    "finetune": {
        ...
        "patch_size": 224,
        "num_workers": 32,
        "ckpt_dir": "train_ckpt_3D_finetune",
    },
}
